...
In theory, the plants contributing to bio-fuel have to meet some criteria: they should not be crops meant for human or animal consumption, ideally a by-product with little to no food value, should not encroach upon cultivable fertile land, and not have heavy water or energy requirement. In summary, the bio-fuel production should not impact food security and strain freshwater sources.

In early 2000s India began experimenting with [*Jatropha curcas* seed oil to produce biodiesel](https://en.wikipedia.org/wiki/Jatropha_biodiesel_in_India# "Wikipedia page"). Jatropha isn't consumed by humans and can grow in slightly arid and harsh conditions. It seemed to meet the basic requirements; however, the project failed. More about it towards the end of the blog. Now, straight to ethanol first.

Recently ethanol is in news in India for replacing 20% petrol in our fuel tanks (E20). In 2025, two documents of the Government of India described the same ethanol policy.

The first, [a press release](https://www.pib.gov.in/PressReleasePage.aspx?PRID=2155558&reg=48&lang=2) from the Ministry of Petroleum and Natural Gas announced that India had achieved 20 % ethanol blending in petrol — five years ahead of schedule — and tallied the winnings as lakhs of crores in foreign exchange saved, lakhs of crores paid to farmers, crores of tonnes of carbon dioxide avoided. A policy triumph.
...
It is an attempt to do the accounting properly. Every litre of ethanol in an Indian petrol tank came from somewhere: from cane, from maize, from rice out of the Food Corporation of India's godowns. This blog dwells on the question of what our food system can and cannot absorb. E20 is a very large withdrawal from that system, and it deserves a balance sheet rather than just a press release. Though this blog doesn't guarantee to be a detailed balance sheet, it is an attempt to clear some haze and contribute to the sane discussion over the topic.

Let's dive into some data.

# What India actually achieved

The scale of the india's ethanol blending ramp-up is genuinely remarkable, and lets open with the positives.
...
![Indian can invest money saved from ethanol blending into infra or upskilling](/images/import_offset.webp){fig-align="center" #fig-offset}

But a saving of US\$ 7 billion is a very long way from the energy independence the programme is often described as delivering.

There is a another side to this problem. As the supply of rice and sugarcane, crops primarily used to make ethanol, tightened, the government raised the administered price for maize-based ethanol to pull maize into distilleries. It worked. It also helped push India from being a maize exporter to a **net importer of maize in 2024**, with exports collapsing from about 1.9 million tonnes a year to around 0.5 million. Exports since then have recovered as the record production in 2024-25 eased supplies. However, this still implies that fuel policies can now have direct implications on food-grain trade balance.

Recently (August - September, 2026) India observed steep rise in sugar costs. Though the government says that this has nothing to do with ethanol policy because only a minor volume of India's sugarcane production is diverted to produce ethanol. However, the government also said that the prices have increased because of poor sugarcane production linked to monsoon deficit, and increased demand for sugar due to festive season.Nonethless, [more sugarcane farmers are now seeking permission](https://www.chinimandi.com/karnataka-farmers-seek-permission-to-produce-ethanol-at-jaggery-units-amid-sugar-price-surge/) to divert their crop for ethanol than for human consumption because of better pricing. To curb the prices of sugar, the government has completely removed the import duty on import of raw sugar. Which means, revenue loss. It would not be incorrect to say that in an event of distress, even a small of fraction of sugarcane diversion to ethanol can upset domestic budgets, especially during the festive season.

A programme justified by import substitution has generated a new import dependency: nudged farmers away from oilseeds. India is the world's largest importer of edible oils, and the data suggests that India's import bill is growing: edible oil imports rose 22 % in value to Rs 1.61 lakh crore in the 2024-25 marketing year, even as import volumes remained flat. In Madhya Pradesh and Maharashtra, India's soybean belt, farmers have swapped soybean for maize, drawn by steadier returns and lower weather risk; soybean area nationally fell 4 percent between 2024 and 2025 as a result. The national oilseed area hasn't collapsed — a record mustard harvest in Rajasthan and the north has kept the aggregate numbers looking healthy — but that masks a quieter substitution happening one season and one state at a time, in exactly the crop most exposed to the ethanol programme's pull on land.

```{r}

#library(ggstream)
getwd()
oilseed_data <- read_csv("oilseeds.csv")
oilseed_data <- rename(oilseed_data, area = `Area (Lakh Ha)`)

ggplot(oilseed_data) +
  geom_area(aes(x=cropyear, y=area, group = cropname, colour = cropname, fill = cropname), 
            alpha = 0.7)
```
...
Lifecycle or "well-to-wheel" analyses generally put grain and sugar ethanol at 30 to 50% lower greenhouse gas emissions than petrol. Argonne National Laboratory's much-cited figure for US corn ethanol is around 40%. So the direction of the effect is not in doubt.
